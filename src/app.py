...
with st.sidebar:
    ...
    with col_hdr1:
        st.image("data/assets/icon_flor_lotus_onlyborders.png", width=24)
    with col_hdr2:
    ...
    col_cnt1, col_cnt2 = st.columns([1, 5])
    with col_cnt1:
        st.image("data/assets/phone.png", width=24)
    with col_cnt2:
    ...
    with colw2: st.markdown("[WhatsApp Directo](https://wa.me/521234567890)  \nSoporte e Inscripciones")
    ...
    with col_clean1:
        st.image("data/assets/icon_settings.png", width=22)
    with col_clean2:
